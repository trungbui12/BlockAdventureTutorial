...
public class Grid : MonoBehaviour
{
    ...
    void CheckIfAnyLineIsCompleted()
    {
        ...
        // TODO: add score for completed lines
        var totalScore = completedLines * 10;
    ...
    private void CheckIfPlayerLost()
    {
        ...
        {
            var isShapeActive = shapeStorage.shapeList[index].IsAnyOfShapeSquaresActive();
    ...
    private bool CheckIfShapeCanBePlacedOnGrid(Shape currentShape)
    {
        ...
        Debug.LogError("Number of filled up squares in shape data is different from the total square number of the shape");
